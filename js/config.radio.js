...
var config = {
	...
	questions: [{
        ...
        type: "radio", // "radio" or "allocation", must all be the same type and must match app question mode above
        ...
        values: [{
            ...
            label: "Oceans & Fisheries",            
            value: "CHOICE110",           
            title: "Clean Oceans and Sustainable Fisheries",            
            color: ["#3186BD", "#3186BD"]        
        }]
    }],
