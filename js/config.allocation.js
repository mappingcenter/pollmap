...
var config = {
	app : {
		...
		questionMode : "allocation", //"autocomplete" or "allocation" or "radio" eventually may allow this on a per-question basis, but not now REQUIRED
		cookieName : "xxx2011UID", // the name of the cookie used to track voters
		theme : "slate", //"foam" or "slate" or... TODO: create theming system :D CSS framework?
		...
		featureService : "http://niflheim/ArcGIS/rest/services/collegefootball/data/MapServer/0", //"http://niflheim.esri.com/ArcGIS/rest/services/earthday/earthday_places/MapServer/0",//"http://pollmap.esri.com/ArcGIS/rest/services/Zips_Winkel/MapServer/0", use for zip validation
		...
		identifyService : "", //unimplemented  // "http://pollmap.esri.com/ArcGIS/rest/services/Zips_Poly_Winkel/MapServer/0",
	...
	questions: [{
        ...
        type: "allocation", // "radio" or "allocation", must all be the same type and must match app question mode above
        
        title: "Earth Day: How would you spend $100?",
        ...
        mapService: "http://pollmap.esri.com/ArcGIS/rest/services/Canvas/Question01/MapServer",
        ...
        values: [{
            ...
            label: "Energy",            
            value: "CHOICE109",            
            title: "Sustainable Alternative Energy",            
            color: ["#7BAA31", "#7BAA31"]        
        }, {
        
            label: "Population",            
            value: "CHOICE110",            
            title: "Population Growth and Family Planning",            
            color: ["#D67163", "#D67163"]        
        }, {        
            label: "Air & Water",            
            value: "CHOICE111",            
            title: "Unpolluted Air and Fresh Water",            
            color: ["#52BEAD", "#52BEAD"]       
        }, {        
            label: "Food Supplies",            
            value: "CHOICE112",            
            title: "Healthy and Sustainable Food Supplies",            
            color: ["#B59252", "#B59252"]       
        }]
    }],

	maps : [{
		mapService : "http://niflheim/ArcGIS/rest/services/collegefootball/map01/MapServer",
		title : "The Big 8",
		values : [{
			label : "108",
			value : "CHOICE108",
